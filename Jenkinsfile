...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128db48-constant-current-driver-using-opamp.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128db48-constant-current-driver-using-opamp.git'
